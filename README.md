...
| **A2UI** | Protocolo v0.9 (`a2ui-agent-sdk`), **catálogo propio** (`StatCard`/`BarChart`/`PlanDePago` + primitivos base — [ADR 0011](docs/adr/0011-a2ui-con-catalogo-basico-del-sdk.md)); la misma superficie se renderiza en **React** y en **Flutter** |
...
│   ├── a2ui_custom_catalog.py catálogo propio: básico + StatCard/BarChart/PlanDePago
